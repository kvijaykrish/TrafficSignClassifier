...
Here is an exploratory visualization of the data set. It is a graph showing the number of images in each class of training set.
...
To cross validate my model, I randomly augumented trainset data by applying affine trasform on original images.
-> My final training set had 4 sets of 34000 number of images + 34799 original preprocessed dataset.
-> My validation set had 12630 number of images.

Augmenting the data set: I decided to generate additional data because:
...
The code for training the model is located the ipython notebook. 
...
The code for calculating the accuracy of the model is located in the Ipython notebook.
